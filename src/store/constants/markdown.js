...
export const PALOUSE = 'Get the lowdown on my drive up to Palouse Falls, from the utterly bizarre Palouse Hills to the raging falls themselves, and everything else in between. Check it Out!'
